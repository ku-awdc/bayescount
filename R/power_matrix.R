...
power_matrix <- function(r = NA, paired = TRUE, T_I = 0.99, T_A = 0.95, N = c(20,20), R = c(1,1), S = c(1,1), mean = 20, k = c(1, 0.7), cor = 0.5, iterations=10^3, alpha=0.025, bnb_priors=c(0,0), use_delta=NA, beta_iters=10^4, use_ml=TRUE, binomial_priors=c(1,1), binomial_cl_adj=0.2){
